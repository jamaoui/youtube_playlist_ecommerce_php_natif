...
<div class="container py-2">
    ...
    if (isset($_GET['success'])) {
        ...
        <div class="alert alert-success" role="alert">
            Votre commande avec le montant <strong>(<?php echo $_GET['total'] ?? 0 ?>)</strong> MAD est bien ajoutée.
        </div>
        <hr>
        <?php
    }
                ...
                <table class="table">
                    ...
                    foreach ($produits as $produit) {
                        ...
                        <tr>
                            ...
                            <td><strike><?php echo $produit['prix'] ?> MAD</strike></td>
                            <td> - <?= $produit['discount'] ?> %</td>
                            <td><?php echo calculerRemise($produit['prix'], $produit['discount']) ?> MAD</td>
